...
(function (A08_2_GoldenerHerbst) {
    A08_2_GoldenerHerbst.shapesLeaves = [
        [
    ...
    function createPaths() {
        A08_2_GoldenerHerbst.leavesPaths = chooseLeavesPaths(A08_2_GoldenerHerbst.shapesLeaves);
    }
    A08_2_GoldenerHerbst.createPaths = createPaths;
    function chooseLeavesPaths(_curves) {
        console.log(A08_2_GoldenerHerbst.shapesLeaves);
        let paths = [];
